...
class Menu:
    ...
    def update(self):
        ...
        if not has_updated:
            color_print(
                "Note: you will have to pull the repository by yourself!", YELLOW
            )
        print()
    ...
    def uninstall(self):
        ...
        color_print(
            "You have to manually rename 'chrome.XXXXXXXXXX.bak/' (if exists) to 'chrome/' if you want to recover your previous configuration.",
            YELLOW,
        )
